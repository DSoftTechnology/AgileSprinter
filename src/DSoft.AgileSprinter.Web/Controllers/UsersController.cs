...
namespace DSoft.AgileSprinter.Web.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(DSoft_AgileSprinterContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,NameWithDomain,FriendlyName,Initials,Status,AdsyncLastUpdate,AdsyncStatus")] Users users)
        {
